...
//
//    /**
//     * STEP 1: Upload file to Cloudinary — claim does NOT need to exist yet.
//     * Customer calls this first, gets back documentUrl + publicId,
//     * then includes those values in the ClaimRequest body.
//     */
//    @Override
...
//
//        // Upload to Cloudinary under a temp folder — will be logically linked when claim is submitted
//        String[] result = cloudinaryService.uploadFile(file, "claim-documents/pre-upload");
...
//                .message("File uploaded. Use documentUrl and publicId in your claim submission body.")
//                .build();
//    }
//
//    /**
//     * STEP 2: Called internally by ClaimService after claim record is saved.
//     * Links Cloudinary-uploaded documents to the new claim in the DB.
//     */
//    @Override
...
//
//    /**
//     * Get all documents for a given claim — returns Cloudinary URLs.
//     */
//    @Override
