...
public class PolicyServiceImpl implements PolicyService {
    ...
    public PolicyResponse purchasePolicy(
        ...
        log.info(
                "Customer userId={} purchasing policy for planId={}",
                userId,
                request.getPlanId());
        ...
        Customer customer = customerRepository
                ...
                .orElseThrow(() -> new BadRequestException(
                        "You must create a customer profile before purchasing a policy"));
        ...
        log.info(
                "Policy purchased: policyId={}, policyNumber={}",
                policy.getPolicyId(),
    ...
    public PolicyResponse issuePolicy(
        ...
        log.info(
                "Admin/Agent issuing policy for customerId={}, planId={}",
    ...
    public PolicyResponse cancelPolicy(
        ...
        if (policy.getStatus() == PolicyStatus.EXPIRED) {
            throw new InvalidPolicyStatusException(
                    "Cannot cancel an expired policy");
        }
    ...
    @Override
    public PagedResponse<PolicyResponse> getAllPolicies(
            int page,
            int size,
            String sortBy,
            String sortDir) {
    ...
    @Override
    public PagedResponse<PolicyResponse> getMyPolicies(
            Long userId,
            int page,
            int size,
            String sortBy,
        ...
        Page<Policy> policyPage =
                policyRepository.findByCustomerCustomerId(
    ...
    private PolicyPlan findActivePlan(Long planId) {
        ...
        if (!plan.isActive()) {
            throw new BadRequestException(
                    "The selected plan is not active and cannot be purchased");
        }
    ...
    private PagedResponse<PolicyResponse> toPagedResponse(
            Page<Policy> policyPage) {

        List<PolicyResponse> records =
